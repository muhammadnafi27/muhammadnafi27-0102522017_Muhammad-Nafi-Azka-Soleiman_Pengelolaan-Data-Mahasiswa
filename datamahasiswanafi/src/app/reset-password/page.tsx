    ...
    <div style={{ position: 'relative', zIndex: 10, width: '100%', maxWidth: '440px', animation: 'fadeIn 0.5s ease-out' }}>
      ...
      <div style={{
        ...
        <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
          ...
          <h1 style={{ fontSize: '1.5rem', fontWeight: 700, color: '#f1f5f9', margin: 0 }}>Buat Password Baru</h1>
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
          ...
          <button
            ...
            style={{
              ...
              transition: 'all 0.2s', opacity: (loading || !token || message?.type === 'success') ? 0.8 : 1, marginTop: '0.5rem'
            }}
            onMouseEnter={(e) => { if (!loading && token && message?.type !== 'success') e.currentTarget.style.transform = 'translateY(-2px)'; }}
            onMouseLeave={(e) => { if (!loading && token && message?.type !== 'success') e.currentTarget.style.transform = 'none'; }}
          >
            {loading ? (
